                        ...
                        {producers.map((producer, index) => (
                            ...
                            >
                                <input
                                    ...
                                    onChange={(e) => {
                                        let newProducerFilter = [
                                            ...producerFilter,
                                        ];
                                        if (e.target.checked) {
                                            newProducerFilter.push(
                                                e.target.value
                                            );
                                        } else {
                                            newProducerFilter =
                                                newProducerFilter.filter(
                                                    (prod) =>
                                                        prod !== e.target.value
                                                );
                                        }
                                        dispatch(
                                            setProducerFilter(newProducerFilter)
                                        );
                                    }}
                                />
                                <span className={`${s.checkmark}`}></span>
                            ...
                            >
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (e.target.checked) {
                                            newCountryFilter.push(
                                                e.target.value
                                            );
                                        } else {
                                            newCountryFilter =
                                                newCountryFilter.filter(
                                                    (cntry) =>
                                                        cntry !== e.target.value
                                                );
                                        }
                                        dispatch(
